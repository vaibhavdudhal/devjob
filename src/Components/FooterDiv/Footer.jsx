  ...
  return (
    <div className='footer p-[5rem] mb-4 bg-blueColor rounded-[10px] gap-8 grid grid-cols-5 m-auto items-start justify-center '>
     ...
     <div className='logoDiv'>
        <h1 className='logo text-[25px] text-white'><strong>Dev</strong>Jobs</h1>
     ...
     <div className='grid '>
      ...
      <div className='grid gap-3'>
        ...
        <li className='text-white opacity-[.7] hover:opacity-[1]'>Conatct Us</li>
      </div>
     ...
     <div className='grid '>
      ...
      <div>
        <small className='text-[14px] text-white '>vaibhavdudhal11@gmail.com </small>
